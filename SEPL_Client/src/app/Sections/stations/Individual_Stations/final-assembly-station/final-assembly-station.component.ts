...
@Component({
  selector: 'app-final-assembly-station',
  standalone: true,
  imports: [ChartsTemplateComponent],
  templateUrl: './final-assembly-station.component.html',
  styleUrl: './final-assembly-station.component.scss'
})
export class FinalAssemblyStationComponent {
  title:any = "FINAL ASSEMBLY STATION"
  endPoint:string = "final_assembly_traceability"
